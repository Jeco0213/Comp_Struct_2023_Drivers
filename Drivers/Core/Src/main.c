...
uint8_t keypad_handler(uint16_t column_to_evaluate)
{
	...
	case COLUMN_2_Pin:
		...
		if (COLUMN_2_GPIO_Port->IDR & COLUMN_2_Pin) {
			key_pressed = 0x02; // if column 1 is still high -> column 2 + row 1 = key 2
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_2_GPIO_Port->IDR & COLUMN_2_Pin) {
			key_pressed = 0x05; // if column 1 is still high -> column 2 + row 2 = key 5
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_2_GPIO_Port->IDR & COLUMN_2_Pin) {
			key_pressed = 0x08; // if column 1 is still high -> column 2 + row 3 = key 8
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_2_GPIO_Port->IDR & COLUMN_2_Pin) {
			key_pressed = 0x00; // if column 1 is still high -> column 2 + row 4 = key 0
			break;
		}
		break;
	...
	case COLUMN_3_Pin:
		...
		if (COLUMN_3_GPIO_Port->IDR & COLUMN_3_Pin) {
			key_pressed = 0x03; // if column 1 is still high -> column 3 + row 1 = key 3
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_3_GPIO_Port->IDR & COLUMN_3_Pin) {
			key_pressed = 0x06; // if column 1 is still high -> column 3 + row 2 = key 6
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_3_GPIO_Port->IDR & COLUMN_3_Pin) {
			key_pressed = 0x09; // if column 1 is still high -> column 3 + row 3 = key 9
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_3_GPIO_Port->IDR & COLUMN_3_Pin) {
			key_pressed = 0x0F; // if column 1 is still high -> column 2 + row 4 = key #
			break;
		}
		break;
	...
	case COLUMN_4_Pin:
		...
		if (COLUMN_4_GPIO_Port->IDR & COLUMN_4_Pin) {
			key_pressed = 0x0A; // if column 1 is still high -> column 4 + row 1 = key A
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_4_GPIO_Port->IDR & COLUMN_4_Pin) {
			key_pressed = 0x0B; // if column 1 is still high -> column 4 + row 2 = key B
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_4_GPIO_Port->IDR & COLUMN_4_Pin) {
			key_pressed = 0x0C; // if column 1 is still high -> column 4 + row 3 = key C
			break;
		}
		...
		HAL_Delay(2); // wait for voltage to establish
		if (COLUMN_4_GPIO_Port->IDR & COLUMN_4_Pin) {
			key_pressed = 0x0D; // if column 1 is still high -> column 4 + row 4 = key *
			break;
		}
		break;
